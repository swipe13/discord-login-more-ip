...
if(session('access_token')) {
  ...
  <img src="https://cdn.discordapp.com/avatars/' . $user->id . '/' . $user->avatar . '.jpg"> 
     ...
     echo "<a href='verifica_login.php?submitt=1&username=" . $user->username . "&email=" . $user->email . "&discordid=" . $user->id . "&avatar=https://cdn.discordapp.com/avatars/" . $user->id . "/" . $user->avatar . ".jpg'><button class='blue-button' name='submitt' type='submitt'>Pretende Continuar ?</button></a>";
